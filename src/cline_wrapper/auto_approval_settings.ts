export interface AutoApprovalSettings {
	...
	actions: {
		...
		cliAllowReadFiles: boolean
		cliAllowReadFilesExternally: boolean
		cliAllowEditFiles: boolean
		cliAllowEditFilesExternally: boolean
		cliAllowExecuteSafeCommands: boolean
		cliAllowExecuteAllCommands: boolean
		cliAllowUseBrowser: boolean
		cliAllowUseMcp: boolean
	}
	// Global settings
...
export const DEFAULT_AUTO_APPROVAL_SETTINGS: AutoApprovalSettings = {
	...
	actions: {
		...
		useBrowser: false,
		useMcp: false,
		cliAllowReadFiles: false,
		cliAllowReadFilesExternally: false,
		cliAllowEditFiles: false,
		cliAllowEditFilesExternally: false,
		cliAllowExecuteSafeCommands: false,
		cliAllowExecuteAllCommands: false,
		cliAllowUseBrowser: false,
		cliAllowUseMcp: false,
	},
	maxRequests: 20,
