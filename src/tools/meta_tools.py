...
class NewTaskTool(Tool):
    ...
    def description(self) -> str:
        return (
            "Request to create a new task with preloaded context covering the conversation with the user "
    ...
    def parameters_schema(self) -> Dict[str, str]:
        return {"context": "The context to preload the new task with."}
...
class AttemptCompletionTool(Tool):
    ...
    def description(self) -> str:
        return (
            "After each tool use, the user will respond with the result of your work. "
...
class PlanModeRespondTool(Tool):
    ...
    def description(self) -> str:
        return (
            "Respond to the user's inquiry in an effort to plan a solution to their problem. "
    ...
    @property
    def parameters_schema(self) -> Dict[str, str]:
        return {"response": "The response to provide to the user."}
...
class LoadMcpDocumentationTool(Tool):
    ...
    def description(self) -> str:
        return (
            "Load documentation about creating MCP servers, including an architectural overview, "
...
class CondenseTool(Tool):
    ...
    @property
    def parameters_schema(self) -> Dict[str, str]:
        return {"context": "Detailed summary of the conversation to be condensed."}
...
class ReportBugTool(Tool):
    ...
    def execute(self, params: Dict[str, Any], agent_tools_instance: Any) -> str:
        ...
        return (
            f"Success: ReportBugTool called. Title: '{title}', What Happened: '{what_happened}', "
...
class NewRuleTool(Tool):
    ...
    def description(self) -> str:
        return (
            "Creates a new Cline rule file in .clinerules directory. (Full implementation pending)"
        )
    ...
    def execute(self, params: Dict[str, Any], agent_tools_instance: Any) -> str:
        ...
        if missing_required:
            return (
                f"Error: Missing required parameters for 'new_rule': {', '.join(missing_required)}."
            )
        ...
        return (
            f"Success: NewRuleTool called. Path: '{path}', Content (preview): '{content_preview}'. "
